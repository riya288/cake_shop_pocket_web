...
if(isset($_GET['dId'])){
    $id = $_GET['dId'];
    $query = "DELETE FROM gallary_category WHERE id = '$id'";
                    ...
                    <div class="row card-box">
                        <div class="col-md-12">
                            <div  id="Show_target_div">
                                <form name="form" action="action/gallary_category.php"
                                      id="form"
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                ...
                                                <img src="../images/gallary/<?php if(isset($row['image']) && !empty($row['image'])){ echo $row['image']; } ?>?" height="100" width="100">
                                                    ...
                                                    <td>
                                                        <a href="gallary_category.php?hId=<?php if (isset($row['id']) &&
                                                        !empty($row['id'])) {echo $row['id'];} ?>" title="Edit">
                                                        <i class="fa fa-edit" style="font-size: 20px;"></i>
                                                        </a>
                                                        <a href="gallary_category.php?dId=<?php if(isset($row['id']) && !empty($row['id'])){ echo $row['id']; }?>" onClick="return confirm('Are you sure you want to delete this record');" title="Delete">
