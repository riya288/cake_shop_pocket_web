                                ...
                                <div class="card-box table-responsive">
                                    ...
                                    <table id="datatable-buttons" class="table table-striped table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php
                                                if(isset($row['bank_name']) && !empty($row['bank_name']))
                                                {
                                                    echo $row['bank_name']; 
                                                }
                                                ?>
                                            ...
                                            <td>
                                                <?php
                                                if(isset($row['ifsc_code']) && !empty($row['ifsc_code']))
                                                {
                                                    echo $row['ifsc_code'];
                                                }
                                                ?>
                                            ...
                                            <td>
                                                <?php
                                                if(isset($row['ac_name']) && !empty($row['ac_name']))
                                                {
                                                    echo $row['ac_name'];
                                                }
                                                ?>
                                            ...
                                            <td>
                                                <?php
                                                if(isset($row['ac_number']) && !empty($row['ac_number']))
                                                {
                                                    echo $row['ac_number'];
                                                }
                                                ?>
                                            ...
                                            <td>
                                                <img src="images/<?php if (isset($row['qr_image']) && !empty($row['qr_image'])) {
                                                    echo $row['qr_image'];
                                                } ?>" height="70" width="70">
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <a href="view_detail.php?dId=<?php if(isset($row['id']) && !empty($row['id'])){ echo $row['id']; }?>" onClick="return confirm('Are you sure you want to delete this record');" title="Delete">
                                                    <i class="fa fa-trash-o" style="font-size: 20px;"></i>
                                                </a>
                                                 <a href="detail.php?hId=<?php if(isset($row['id']) && !empty($row['id'])){ echo $row['id']; }?>" target="_blank" title="Edit">
