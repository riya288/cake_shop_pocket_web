                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">ADD EMPLOYEE ecard </h4>
                                    <ol class="breadcrumb p-0 m-0">
                                        <li>
                                            <a href="index.php">Home</a>
                                        </li>
                                        <li>
                                            <a href="view_ecard.php"> View Employee List</a>
                                        </li>
                                    </ol>
                        ...
                        <div class="row card-box">
                            <div class="col-md-12">
                                <div  id="Show_target_div">
                                    <form name="form" action="action/ecard.php/" id="form" method="post"  enctype="multipart/form-data">
                                        <div class="row">
