                                            ...
                                            <div class="col-md-12 p-5">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label class="form-label" for="watsapp_link">Watsapp Link:</label>
                                                                <input type="text" name="watsapp_link" id="watsapp_link" class="form-control" value="<?php if
                                                                        (isset($watsapp_link) && !empty($watsapp_link)) {echo $watsapp_link;} ?>">
                                ...
                                <div class="card-box table-responsive">
                                    ...
                                    <table id="datatable" class="table table-striped table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php
                                                if(isset($row['watsapp_link']) && !empty($row['watsapp_link']))
                                                {
                                                    echo $row['watsapp_link']; 
                                                }
                                                ?>
                                            </td>
                                            <td>
